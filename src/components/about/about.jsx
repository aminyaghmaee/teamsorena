      ...
      <div className="right-r">
        ...
        <div className="details-r">
          <div>
            ...
            <span>
              تیم سورنا با کمک بهترین مربیان کشور و قهرمانان جهان در بیش از هفده
              رشته ورزشی آماده خدمت رسانی به تمامی ورزش دوستان میباشد.
            </span>
          </div>
          <div>
            <img src={tick} alt="" />
            <span>تیم سورنا با کمک بهترین مربیان کشور و قهرمانان جهان در بیش از هفده
              رشته ورزشی آماده خدمت رسانی به تمامی ورزش دوستان میباشد.</span>
          </div>
          <div>
            <img src={tick} alt="" />
            <span>تیم سورنا با کمک بهترین مربیان کشور و قهرمانان جهان در بیش از هفده
